#_(ns wraith-king.db.datomic.dead-letter-test
...
#_(schema-test/deftest lookup-test&insert-test
...
#_(schema-test/deftest active-test
                       (let [mocked-datomic (component.datomic/mocked-datomic datomic.config/schemas)]
                         (datomic.dead-letter/insert! fixtures.dead-letter/internal-dead-letter mocked-datomic)
...
#_(schema-test/deftest mask-as-processed!-test
                       (let [mocked-datomic (component.datomic/mocked-datomic datomic.config/schemas)]
                         (datomic.dead-letter/insert! fixtures.dead-letter/internal-dead-letter mocked-datomic)
...
#_(schema-test/deftest mark-as-dropped!-test
                       (let [mocked-datomic (component.datomic/mocked-datomic datomic.config/schemas)]
                         (datomic.dead-letter/insert! fixtures.dead-letter/internal-dead-letter mocked-datomic)
...
#_(deftest mark-as-unprocessed!-test
           (let [mocked-datomic (component.datomic/mocked-datomic datomic.config/schemas)]
